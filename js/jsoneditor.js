...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.addproperty_add = this.getButton('add','add',this.translate("button_add_properties"));
      ...
      // Edit JSON Button
      this.editjson_button = this.getButton('JSON','edit',this.translate('button_edit_json'));
      ...
      this.addproperty_button = this.getButton('Properties','edit',this.translate("button_object_properites"));
  ...
  addObjectProperty: function(name, prebuild_only) {
    ...
    // New property
      ...
      // Add by mattyu
      if(schema.format=='relative path'){
        for(let i in schema.watch){
          schema.watch[i]=self.path+'.'+schema.watch[i];
        }
      }
      // Add the property
      var editor = self.jsoneditor.getEditorClass(schema);
